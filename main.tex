...
We believe that by connecting commonly used modeling frameworks (e.g., scikit-learn and TensorFlow) to Ground we will be able to helo developers identify the correct data to train models and automatically update models as new data arrives. 
...
Furthermore, as prediction services are composed (e.g., in predicting musical genres and scoring content), Ground can provide a broader view of these services and help isolating failing models. 
